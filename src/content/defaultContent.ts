...
export const defaultContent: SiteContent = {
  ...
  about: {
    ...
    paragraphs: [
      ...
      "Кураторы проектов имеют опыт работы в организации форумов на 800+ человек с топовыми спикерами: Радиславом Гандапасом, Алексеем Ситниковым, Владимиром Якубой, Игорем Рызовым.",
      "Мы выигрываем тендеры по всей России. В каждом городе у нас есть свои представители, и мы лично приезжаем на мероприятие.",
    ],
